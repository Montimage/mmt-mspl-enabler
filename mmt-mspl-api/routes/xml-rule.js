...
router.put('/', function (req, res, next) {
    ...
    fs.writeFile(filePath, fileContent, 'utf8', (err) => {
        ...
        exec(`docker cp ${filePath} mi_probe:/opt/mmt/security/bin/new_rule.xml`, (error, stdout, stderr) => {
            if (error) {
                ...
                exec(`docker exec mi_probe ./opt/mmt/security/bin/compile_rule /opt/mmt/security/rules/114.new.so /opt/mmt/security/bin/new_rule.xml`, (error, stdout, stderr) => {
                    if (error) {
